...
<div class="container">
	...
	<div class="col-md-6">
		...
		<form class="form-group" method="post">
			<div>
		<input type="text" class="form-control" name="name" placeholder="Company Name" required><br>
...
$sql="INSERT INTO users(name, email, phone, address, foi, user, pass)VALUES('$name', '$email', '$phone', '$add', '$filename', '$user', '$pass')";
//echo $sql;
