...
?>
		...
		<fieldset>
			<legend><i class="fas fa-file"></i> Credentials</legend>
			<?php
$id=$_GET['id'];
...
if($count==0){
	echo '<h3><font color=""><i class="fas fa-exclamation-circle"></i> There are no file(s) yet for this account!</font></h3>';
}else{
...
<div class="responsive">
  <div class="img">
    <a target="_blank" href="../images/<?php echo $rows['cred']; ?>">
      <img src="../images/<?php echo $rows['cred']; ?>" alt="<?php echo $rows['cred_name']; ?>" title="Click to View Full Size" width="200">
    </a>
