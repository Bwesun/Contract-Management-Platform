...
<div class="container">
	...
	<div class="col-md-9">
		...
		<div>
			...
			<a href="add_contract.php" class="btn btn-default btn-bg btn-lg"><i class="fas fa-user-plus"></i>  Add Contract</a>
			<a href="view_contracts.php" class="btn btn-default btn-bg btn-lg"> <i class="fas fa-address-card"></i>  View Contracts </a>
			<a href="delete_contract.php" class="btn btn-default btn-bg btn-lg"> <i class="fas fa-eraser"></i>  Delete Contracts</a>
			<a href="applications.php" class="btn btn-default btn-bg btn-lg"> <i class="fas fa-edit"></i>  Contract Applications</a>
		</div>
	</div>
</div>
