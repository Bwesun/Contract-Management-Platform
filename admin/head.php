...
<div id="wrapper">
	<div style="padding: 10px 0px 0px 10px;">
		<h2 class=""><a href="index.php"><div align=""><img src="../log.jpg" width="100" class="img-circle img-thumbnail"></div></a><font color="grey">Contract Management System: Control Panel </font></h2>
	</div>
