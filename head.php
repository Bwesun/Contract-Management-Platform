...
<div id="wrapper">
	<div style="padding: 10px 0px 0px 10px;">
		<h2 class=""><a href="index.php"><div align=""><img src="log.jpg" width="100" class="img-circle img-thumbnail"></div></a><font color="grey">NILEST Contract Management Portal</font></h2>
	</div>
	...
	<div class="collapse navbar-collapse" id="example-navbar-collapse">
		<ul class="nav navbar-nav">
			...
			<li><a href="credentials.php">Documents  <i class="fas fa-file"></i></a></li>
