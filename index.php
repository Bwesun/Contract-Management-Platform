...
<div class="container">
	...
	<div class="col-md-9">
		...
		<div>
			...
			<a href="view_contracts.php" class="btn btn-default btn-bg btn-lg"><i class="fas fa-user-plus"></i>  View Available Contract(s)</a>
			<a href="applied_contracts.php" class="btn btn-default btn-bg btn-lg"> <i class="fas fa-address-card"></i>  View Applied Contract(s) </a>
		</div>
	</div>
</div>
